                                            ...
                                            >
                                                ...
                                                <div class="flex items-center">
                                                    <template x-if="status === 'idle'">
                                                        <svg @click="isEditing = true; focus()" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-blue-600">
