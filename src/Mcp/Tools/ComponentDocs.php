...
{
    protected string $name = 'bt-tables-component-docs';

    protected string $description = 'Get detailed documentation for a specific Beartropy Tables component including props, slots, examples, and architecture details.';
